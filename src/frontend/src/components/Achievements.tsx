const ACHIEVEMENTS = [
  {
    ...
    description:
      "Scored 92.80% in SSC from Vivekananda English School, demonstrating exceptional academic performance and discipline.",
    icon: "🏆",
    year: "2021",
    highlight: "92.80% SSC",
  },
  {
    ...
    description:
      "Independently built and deployed Lexpert, a live production web application serving real users — from concept to cloud in record time.",
    icon: "🚀",
    year: "2025",
