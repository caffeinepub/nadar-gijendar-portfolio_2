          ...
          <div data-aos="fade-right">
            <div className="glass-card" style={{ padding: "2.5rem" }}>
              ...
              >
                ...
                , a legal academic web platform. Quick learner with strong
                adaptability and capable of delivering high-quality solutions
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: "0.6rem" }}>
                {[
                  ...
                  <span key={trait} className="skill-badge">
                    {trait}
                  </span>
                ))}
              </div>
